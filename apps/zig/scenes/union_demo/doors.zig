...
const ROUTES = [_]Route{
    ...
    .{ .demo_name = "SUPERSCROLLER_LOADER", .screen = .superscroller_screen, .title = "TCB2", .tag = "union_superscroller" },
    ...
    .{ .demo_name = "TNT2_LOADER", .screen = .tnt2_screen, .title = "TNT2", .tag = "union_tnt2" },
