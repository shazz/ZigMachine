...
const WANT = ["union_beatdis", "union_deltaforce", "union_tnt3", "union_tnt1", "union_reps", "union_tnt2", "union_l16", "union_multifake", "union_texcopier", "union_textracker"]; // by teleport key: doors '1', '2', '3', '5', '6', '7', '8', '9', '0', 'H'
const DIR = { fire: 5 };
