// Headless TEX NEO SHOW driver: boots the sealed machine + the cart the way
...
//
//   node apps/tex_neoshow_headless.mjs [outdir] [dt_ms] [frame,frame,...]
...
const { memory, machine, demo } = await boot("docs/demo-tex_neoshow.wasm");
...
const out = process.argv[2] || "/tmp/tex_neoshow";
const dt = Number(process.argv[3] || 1000 / 60);
// frame f draws iteration f-1; iteration_img = f-211: dragon from 211, einhorn 421, midearth 631, moreta 841, porsche 1051, tut_ench 1261
const wanted = (process.argv[4] || "1,211,226,300,400,440,500,650,700,900,1100,1300,1471")
...
// Warm frame cost, best of 5 runs of 600 frames: the cart's frame()
