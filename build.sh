...
gate gen4_3615 node apps/gen4_3615_headless.mjs "$SHOTS/gen4_3615"   # ULM 3615 GEN4: screen.js replayed (matched to the page in Chrome) at ten frames from 1 to 30000, through THE FATE's appearance and all six waveforms, with the YM volumes driven: the whole 400x280 plane pixel for pixel; the sky, VU colours and floor shading are colour registers changed per line; side and bottom borders open, top shut; the remake's SNDH plays
